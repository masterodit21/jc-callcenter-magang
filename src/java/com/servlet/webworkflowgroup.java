 ...
 * @author rkrzmail
 */
public class webworkflowgroup extends NikitaServlet{

    
    public void OnCreate(NikitaRequest request, NikitaResponse response, NikitaLogic logic) {
        NikitaForm nf = new NikitaForm(this);
        nf.setText("Nikita Workflow Group");
        ...
        btn.setOnClickListener(new Component.OnClickListener() {
            ...
            public void OnClick(NikitaRequest request, NikitaResponse response, Component component) {
                ...
                response.showform("webworkflowgroupadd", request,"add", true);
                response.write();
            }
        });        
        ...
        tablegrid.setDataHeader(Nset.readsplitString("No|Name|Title|Describe|Group|Type|"));//No|Name|User Name|Password|Class|Url|
        ...
        nf.setOnActionResultListener(new NikitaForm.OnActionResultListener() {
            ...
            public void OnResult(NikitaRequest request, NikitaResponse response, Component component, String reqestcode, String responsecode, Nset result) {
                ...
                if(reqestcode.equals("delete") && responsecode.equals("button2")){
                    ...
                    Nikitaset nikitaset = nikitaConnection.Query("delete from web_workflow where wfid=?",result.getData("id").toString());
                    fillGrid(response);
                    response.writeContent();
                }
            }
        ...
        comp.setOnClickListener(new Component.OnClickListener() {
            ...
            public void OnClick(NikitaRequest request, NikitaResponse response, Component component) {
                ...
                response.showform("connectionadd", request,"edit", true);
                response.write();
        ...
        comp = new Component();
        comp.setId("con-btnDesign");
        nf.addComponent(comp);
        comp.setOnClickListener(new Component.OnClickListener() {
            @Override
            public void OnClick(NikitaRequest request, NikitaResponse response, Component component) {
                request.setParameter("wfdata", component.getTag());
                request.setParameter("wfdesign","design");
                
                
                request.setParameter("mode","edit");
                response.showform("webworkflow", request,"edit", true);
                response.write();
    ...
    private void fillGrid(NikitaResponse response){
        ...
        //No|Name|Title|Describe|Group|Tyoe|
        //wfid,wfname,wftitle,wfdescribe,wfgroup,wftype,wfinput,wfdesigndata,wfindex,wfstatus
 
        if(txt.getText().equals("")){
            Nikitaset nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"select wfid,wfname,wftitle,wfdescribe,wfgroup,wftype,wfinput,wfindex,wfstatus "+ 
                                                       "from web_workflow");
            ...
            Nikitaset nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"select wfid,wfname,wftitle,wfdescribe,wfgroup,wftype,wfinput,wfindex,wfstatus "+ 
                                                       "from web_workflow where wfname like ? OR wftitle like ? OR wfdescribe like ? ; ",s,s,s);
            tablegrid.setData(nikiset);
        }
