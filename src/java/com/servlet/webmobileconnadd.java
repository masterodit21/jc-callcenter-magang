 ...
 * @author user
 */
public class webmobileconnadd extends NikitaServlet{
    ...
    */
    ...
    public void OnCreate(NikitaRequest request, NikitaResponse response, NikitaLogic logic) {
        ...
        btn.setOnClickListener(new Component.OnClickListener() {        
            ...
            public void OnClick(NikitaRequest request, NikitaResponse response, Component component) {
                ...
                if(mode.equals("edit")){                    
                    ...
                    Nikitaset nikitaset = nikitaConnection.Query("insert into web_connection_mobile("+
        ...
        nf.setOnActionResultListener(new NikitaForm.OnActionResultListener() {
            ...
            public void OnResult(NikitaRequest request, NikitaResponse response, Component component, String reqestcode, String responsecode, Nset result) {
                ...
                if(reqestcode.equals("update") && responsecode.equals("button2")){
                    ...
                    Nikitaset nikitaset;
                    nikitaset = nikitaConnection.Query("SELECT connpassword FROM web_connection_mobile WHERE connid = ?", id); 
                    ...
                    nikitaset = nikitaConnection.Query("update web_connection_mobile set connname=?,connusername=?,connpassword=?,connclass=?,connurl=?,"+
        ...
        if(mode.equals("edit")){
            nf.setText("Mobile Connection Edit");
