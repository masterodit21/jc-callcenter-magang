 ...
 * @author user
 */
public class moduleadd extends NikitaServlet{
    ...
    */
    ...
    public void OnCreate(NikitaRequest request, NikitaResponse response, NikitaLogic logic) {
        ...
        nf.setOnActionResultListener(new NikitaForm.OnActionResultListener() {
            ...
            public void OnResult(NikitaRequest request, NikitaResponse response, Component component, String reqestcode, String responsecode, Nset result) {
                ...
                if(reqestcode.equals("update") && responsecode.equals("button2")){
                    ...
                    String mode = nset.getData("mode").toString();
                    String id = nset.getData("id").toString();  
                    Nikitaset nikitaset = nikitaConnection.Query("update web_module set moduleid=?,modulename=?,modulestyle=?"+
                                          "where moduleid=?",
                                          id,
                                          response.getContent().findComponentbyId("modulAdd-txtName").getText(),
                                          response.getContent().findComponentbyId("modulAdd-txtStyle").getText(),
        ...
        if(mode.equals("edit")){
            ...
            nf.findComponentbyId("modulAdd-txtStyle").setText(nset.getData(3).toString());
