 ...
 * @author user
 */
public class webnewresources extends NikitaServlet{
    ...
    public void OnCreate(NikitaRequest request, NikitaResponse response, NikitaLogic logic) {
        ...
        tablegrid.setDataHeader(Nset.readsplitString("No,resname,resfname,ressize,restype,resdescribe,reshash,",","));
        ...
        btn.setOnClickListener(new Component.OnClickListener() {
            public void OnClick(NikitaRequest request, NikitaResponse response, Component component) {
                ...
                Nikitaset nikiset = nikitaConnection.Query("select resid from web_resource where resname NOT IN (SELECT resname FROM web_module_resource) ORDER BY resid ASC  ");
                ...
                response.setResult("new-res",result);
    ...
    public void fillGrid(NikitaResponse response){
        ...
        Nikitaset nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"select resid,resname,resfname,ressize,restype,resdescribe,reshash,1 from web_resource where resname NOT IN (SELECT resname FROM web_module_resource) ORDER BY resid ASC  ");
