 ...
 * @author user
 */
public class webform1 extends NikitaServlet{
    ...
    public void fillGrid(NikitaResponse response){ 
        ...
        if(txt.getText().equals("")){
            if (combo.getText().equals(ALL)) {
                if(idtype.getTag().equals("duplicate")){
                    nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"SELECT formid,formname,formtitle,formtype,formstyle,formdescribe,createdby,formindex "+ 
                                                       "FROM web_form WHERE "+(response.getContent().findComponentbyId("filter").getText().contains("myform")?"createdby = '"+user+"' AND ":"")+" formname IN(SELECT formname FROM (SELECT formname,count(*) AS cnt FROM web_form GROUP BY formname) m2m WHERE cnt >= 2) ORDER BY formname,formid;");
                }else{                
                    nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"SELECT formid,formname,formtitle,formtype,formstyle,formdescribe,createdby,formindex,DBL.cnt "+ 
                                " FROM web_form LEFT JOIN (SELECT formname AS fnm,count(*) AS cnt FROM web_form GROUP BY formname)as DBL ON(web_form.formname=DBL.fnm) "+(response.getContent().findComponentbyId("filter").getText().contains("myform")?" WHERE createdby = '"+user+"' "+(idtype.getText().equals("")?"":" AND (formtype ='"+idtype.getText()+"' OR formtype = '"+x+"')"+"")+" ":""+(idtype.getText().equals("")?"":" WHERE (formtype ='"+idtype.getText()+"' OR formtype = '"+x+"')"+"")+" ORDER BY formindex ASC;"));
                }
            }else{
                if(idtype.getTag().equals("duplicate")){
                    nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"SELECT formid,formname,formtitle,formtype,formstyle,formdescribe,createdby,formindex "+ 
                                                       "FROM web_form WHERE  "+(response.getContent().findComponentbyId("filter").getText().contains("myform")?"createdby = '"+user+"' AND ":"")+" formtype ='"+combo.getText()+"'"+
            ...
            if (combo.getText().equals(ALL)) {
                if(idtype.getTag().equals("duplicate")){
                    nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"SELECT formid,formname,formtitle,formtype,formstyle,formdescribe,createdby,formindex "+ 
                                                       "FROM web_form WHERE  "+(response.getContent().findComponentbyId("filter").getText().contains("myform")?"createdby = '"+user+"' AND ":"")+" (formname LIKE ? OR formtitle LIKE ? ) "+ 
                    ...
                    nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"SELECT formid,formname,formtitle,formtype,formstyle,formdescribe,createdby,formindex,DBL.cnt  FROM web_form LEFT JOIN (SELECT formname AS fnm,count(*) AS cnt FROM web_form GROUP BY formname)as DBL ON(web_form.formname=DBL.fnm) WHERE  "+(response.getContent().findComponentbyId("filter").getText().contains("myform")?"createdby = '"+user+"' AND ":"")+" (formname LIKE ? OR formtitle LIKE ? ) " + (idtype.getText().equals("")?"":" AND (formtype ='"+idtype.getText()+"' OR formtype = '"+x+"') ORDER BY formindex ASC;"),s,s);
                }
            }else{   
                if(idtype.getTag().equals("duplicate")){
                    nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"SELECT formid,formname,formtitle,formtype,formstyle,formdescribe,createdby,formindex "+ 
                                                       "FROM web_form WHERE "+(response.getContent().findComponentbyId("filter").getText().contains("myform")?"createdby = '"+user+"' AND ":"")+" (formname LIKE ? OR formtitle LIKE ? ) AND formtype ='"+combo.getText()+"'"+
                                                       " AND formname IN(SELECT formname FROM (SELECT formname,count(*) AS cnt FROM web_form GROUP BY formname) m2m WHERE cnt >= 2) ORDER BY formname,formid;",s,s);
                
                }else{
                    nikiset = nikitaConnection.QueryPage(tablegrid.getCurrentPage(),tablegrid.getShowPerPage(),"SELECT formid,formname,formtitle,formtype,formstyle,formdescribe,createdby,formindex,DBL.cnt  FROM web_form LEFT JOIN (SELECT formname AS fnm,count(*) AS cnt FROM web_form GROUP BY formname)as DBL ON(web_form.formname=DBL.fnm) WHERE "+(response.getContent().findComponentbyId("filter").getText().contains("myform")?"createdby = '"+user+"' AND ":"")+" (formname LIKE ? OR formtitle LIKE ? ) AND formtype ='"+combo.getText()+"' ORDER BY formindex ASC;",s,s);
                }
            }
            tablegrid.setData(nikiset);
        }
        combo.setData(new Nset(nikitaConnection.Query("select distinct formtype from web_form "+(idtype.getText().equals("")?"":" WHERE formtype ='"+idtype.getText()+"' OR formtype = '"+x+"' ORDER BY formindex;")).getDataAllVector()));
